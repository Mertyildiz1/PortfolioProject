...
public class TC16 {
    ...
    public void test16() throws IOException {
        ...
        ReusableMethods.report("Ürün Arama", "Arama fonksiyonu doğrulama", "Geçerli bir ürün adı girildiğinde, arama sonuçlarının doğru şekilde filtrelendiğini ve ilgili ürünlerin görüntülendiğini doğrulama", "Mert Yıldız");
