...
public class TC35 {
    ...
    public void test35() throws IOException {
        ...
        ReusableMethods.report("Contact Us", "Boş Email alanı ile Form Gönderme", "Boş email alanı ile form gönderildiğinde hata mesajı görüntülenmeli", "Mert Yıldız");
        ...
        try {
            ...
            softAssert.assertTrue(emailValidationMessage != null && !emailValidationMessage.isEmpty(), "Boş email için hata mesajı görüntülenmedi!");
            extentTest.info("Boş email alanı için hata mesajı başarıyla görüntülendi: " + emailValidationMessage);
